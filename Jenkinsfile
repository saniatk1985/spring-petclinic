        ...
        stage('Deploy') {
            steps {
              withCredentials([[
                ...
                sh 'ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i ./hosts --private-key=${keyfile} --extra-vars "db_name=pc db-port=3306 db_user=san db_pass=1234" playbook1.yml'  
