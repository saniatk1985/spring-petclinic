        ...
        stage('Deploy') {
            steps {
              withCredentials([[
                ...
                sh 'ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i ./hosts --private-key=${keyfile} --extra-vars "db_name=pc db-port=3306 ap_user=san ap_pass=123456" playbook_app1.yml ' 
