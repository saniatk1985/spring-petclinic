        ...
        stage('copy to remote host and start') {
           ...
           //}
            ...
            steps {
                ...
                sh 'ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -vvv -i ./hosts --private-key=${keyfile} --user ec2-user --extra-vars "build_number=${BUILD_NUMBER}" playbook_docker.yml'  
